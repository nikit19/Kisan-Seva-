...
//                }
                ...
                Intent i = new Intent(SurveyActivity.this, WebActivity.class);
                i.putExtra("link","http:/www.unhealthy-look.surge.sh/?district=ambala");
                i.putExtra("title","Production Details");
                startActivity(i);
            }
        });
