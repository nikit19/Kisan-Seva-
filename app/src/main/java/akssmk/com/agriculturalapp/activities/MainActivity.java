...
public class MainActivity extends AppCompatActivity
    ...
    private Integer[] imageUrls={R.drawable.produ,R.raw.treat,R.raw.shc2,R.drawable.prod,R.drawable.hor,R.raw.govp};
    ...
    private String[] backgroundColors={"#35e372","#35e372","#35e372","#35e372","#35e372","#35e372"};
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.bazar_rates_nav) {
            ...
            String uriText = "mailto:" + Uri.encode("gormint@gmail.com") + "?subject=" +
    ...
    public boolean onCreateOptionsMenu(Menu menu)
    {
        ...
        inflater.inflate(R.menu.chak, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.noti:
            {
                Intent LaunchIntent = getPackageManager().getLaunchIntentForPackage("org.loklak.wok");
            ...
            case R.id.susi:
            {
                Intent LaunchIntent = getPackageManager().getLaunchIntentForPackage("ai.susi");
                startActivity( LaunchIntent );
                return true;
            }
